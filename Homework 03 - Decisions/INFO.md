...
If you were doing this problem in real life, the program should ask the user to enter a value of h in m using the input() funtion. <br />
<img src = "assets/h0301_0.png" width = "600"> <br />
Requirements: 
